...
**Status (2026-08-16): v0.1.0-v0.4.0 implemented and passing** (8 test
files under `vanic test`, LLVM and C backends both verified on all 3
...
See `examples/ml_demo.vani`, `examples/autodiff_demo.vani`, and
`examples/layers_demo.vani` for end-to-end tours.
